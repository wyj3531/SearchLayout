...
public class DensityUtil {
    ...
    public static float getBaseScale(Context context) {
        return context.getResources().getDisplayMetrics().widthPixels / (context.getResources().getDisplayMetrics().density * 360);
    }
}
